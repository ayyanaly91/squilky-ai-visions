...
function HeroSection() {
  return <section id="top" className="relative flex h-[100svh] min-h-[640px] flex-col overflow-hidden bg-background px-4 sm:px-6 md:px-10">
    ...
    <div className="relative z-20 mt-[8vh] text-center md:mt-[5vh]">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: .1, duration: .7, ease }} className="relative mb-4 flex items-center justify-center gap-3 text-xs font-medium tracking-[.25em] text-primary md:text-sm"><span className="h-px w-10 bg-primary shadow-[0_0_8px_#00e5ff]" /><span className="relative">AI WEB DEVELOPMENT • AI AGENTS<span aria-hidden className="text-shimmer absolute inset-0 rounded" /></span><span className="h-1.5 w-1.5 rounded-full bg-primary shadow-[0_0_10px_#00e5ff]" /></motion.div>
